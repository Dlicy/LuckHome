...
//第一种子类函数
//类型1
int Thing::calculateMoney(vector<Thing*>category, int j) {
	return 0;
}
...
//类型3
int Thing::calculateMoney(std::vector<Thing*>* category, std::vector<Thing*>* playerItem, int j) {
	return 0;
}
...
//类型4
int Thing::calculateMoney(std::vector<Thing*>* category, std::vector<Props*>* playerScene, std::vector<Thing*>* playerItem, std::vector<Essence*>* playerEssence, int j) {
	return 0;
}
//类型5
int Thing::calculateMoney(std::vector<Thing*>* category, int counter, int counter_now, int j) {
	return 0;
}
