...
public:
	...
	//第一种子类函数
	virtual int calculateMoney(vector<Thing*> category, int j);
	virtual int calculateMoney(vector<Thing*> category);
	virtual int calculateMoney(vector<Thing*>* category);
	//第一种类型
	virtual int calculateMoney(vector<Thing*>* category, int j);
	//第二种类型
	virtual int calculateMoney(std::vector<Thing*>* category, std::vector<Thing*>* playerItem, int j);
	virtual int calculateMoney(std::vector<Thing*>* category, std::vector<Thing*>* playerItem);
	//第三种	类型
	virtual int calculateMoney(std::vector<Thing*>* category, std::vector<Props*>* playerScene, std::vector<Thing*>* playerItem, std::vector<Essence*>* playerEssence, int j);
	//第四种类型
	virtual int calculateMoney(std::vector<Thing*>* category, int counter, int counter_now, int j);
